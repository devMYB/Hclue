...
def update_api_service():
    ...
    try:
        ...
        if old_url in content:
            ...
            print(f"ℹ️  {api_file} already uses correct URL or uses environment variable")
            return True
...
def update_auth_context():
    ...
    try:
        ...
        if old_url in content:
            ...
            print(f"ℹ️  {auth_file} already uses correct URL or uses environment variable")
            return True
...
def main():
    ...
    print("=" * 40)
    print(f"Local Network IP: 90.0.0.3")
    print(f"Public IP: 173.64.31.20")
    print()
